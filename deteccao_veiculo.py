...
net = cv2.dnn.readNet("vehicle-detection.weights", "vehicle-detection.cfg")
classes = []
with open("vehicle-detection.names", "r") as f:
    classes = [line.strip() for line in f.readlines()]

layer_names = net.getUnconnectedOutLayersNames()

# Leitura das configurações do YOLO a partir do arquivo lpscr.data
with open("vehicle-detection.data", "r") as data_file:
